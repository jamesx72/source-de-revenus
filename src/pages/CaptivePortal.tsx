...
export default function CaptivePortal() {
  ...
  return (
    <div className="min-h-screen bg-[#050614] font-sans text-white relative overflow-hidden flex items-center justify-center p-4">
      ...
      {/* Back to demo link */}
      <Link to="/" className="absolute top-6 left-6 flex items-center gap-2 text-slate-400 hover:text-white font-medium z-10 transition-colors">
        <ChevronLeft size={20} />
        Retour au site
      </Link>

      {/* Phone Mockup */}
      <div className="bg-[#050614]/50 border border-white/10 rounded-[3rem] p-4 shadow-2xl shadow-indigo-500/20 relative backdrop-blur-xl" style={{ width: '380px', height: '780px' }}>
        {/* Dynamic Island / Notch */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-6 bg-[#050614] rounded-b-2xl z-50 shadow-inner"></div>
        
        {/* Screen */}
        <div className="bg-[#0b0c21]/40 backdrop-blur-2xl w-full h-full rounded-[2rem] overflow-hidden relative flex flex-col border border-white/10 shadow-inner">
          ...
          <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="h-48 bg-slate-200 relative">
                  ...
                  <div className="absolute bottom-4 left-6 right-6">
                    <h2 className="text-white text-2xl font-bold">Le Café Central</h2>
                ...
                <div className="flex-1 p-6 flex flex-col overflow-y-auto pb-8">
                  <div className="mb-6">
                    <h3 className="font-bold text-lg text-white mb-2">Bon retour, Alex ! 👋</h3>
                    <p className="text-slate-400 text-sm">Vous avez accumulé <span className="text-indigo-400 font-bold bg-indigo-500/10 px-2 py-0.5 rounded-md">120 points</span>. Choisissez votre accès :</p>
                  </div>
                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    >
                      ...
                      <div className="flex-1 text-left">
                         <div className="flex items-center gap-2 mb-1">
                          <h4 className="font-bold text-white">Premium 2 Heures</h4>
                        </div>
                    ...
                    <button 
                      ...
                      className="w-full flex items-center p-4 border border-white/10 bg-white/5 rounded-2xl hover:bg-white/10 transition-colors backdrop-blur-sm"
                    >
                      <div className="flex-1 text-left">
                         <div className="flex items-center gap-2 mb-1">
                          <h4 className="font-bold text-white">Premium 2 Heures</h4>
                        </div>
                        <p className="text-xs text-slate-400">Haut débit sans pub</p>
                      </div>
                      <div className="font-bold text-lg text-white px-3 py-1 bg-white/10 rounded-lg">2 €</div>
                    </button>
                    ...
                    >
                      <div className="flex-1 text-left">
                         <div className="flex items-center gap-2 mb-1">
                          <h4 className="font-bold text-white">Pass Journée</h4>
                        </div>
                        <p className="text-xs text-slate-400">Illimité 24h</p>
                      </div>
                      <div className="font-bold text-lg text-white px-3 py-1 bg-white/10 rounded-lg">5 €</div>
                    </button>
                  </div>
                  ...
                  <div className="mt-auto">
                    ...
                    <div className="flex gap-4 max-w-[200px] mx-auto">
                      ...
                      <button className="flex-1 p-3 flex justify-center items-center rounded-xl bg-white/5 border border-white/10 text-white hover:bg-white/10 transition-colors">
            ...
            {step === 'ad' && (
              <motion.div 
                ...
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                className="flex flex-col h-full bg-transparent text-white"
              >
                <div className="flex-1 relative flex items-center justify-center">
                  <div className="absolute top-6 right-6 text-xs font-bold text-white/70 bg-black/40 border border-white/10 px-3 py-1.5 rounded-full z-10 backdrop-blur-md">
            ...
            {step === 'success' && (
              ...
              >
                ...
                <h2 className="text-3xl font-bold text-white mb-2 relative z-10">Connecté !</h2>
                <p className="text-indigo-200 font-medium px-4 relative z-10">Vous avez désormais accès à Internet.</p>
                
                <div className="mt-8 bg-white/5 border border-white/10 p-6 rounded-2xl shadow-sm w-full max-w-[280px] relative z-10 backdrop-blur-md">
                  <p className="text-sm text-slate-400 font-medium mb-1">Temps restant</p>
                  <p className="text-3xl font-bold text-white">29:59</p>
                </div>
            ...
            {step === 'payment' && (
              ...
              >
                <button 
                  ...
                  className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-400 hover:text-white hover:bg-white/10 transition-colors mb-6 flex-shrink-0"
                >
                  <ChevronLeft size={20} />
                </button>
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-4 flex justify-between items-center mb-8 backdrop-blur-sm">
                  <div>
                    <p className="font-semibold text-white text-sm">Pass Express (2H)</p>
                    <p className="text-xs text-slate-400">Le Café Central</p>
                  </div>
                ...
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-slate-400 mb-1">Email (pour le reçu)</label>
                    <input type="email" placeholder="client@email.com" className="w-full px-4 py-3 bg-white/5 border border-white/10 text-white rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 placeholder:text-slate-600" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-slate-400 mb-1">Carte bancaire</label>
                    <div className="relative">
                      <CreditCard className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500" size={20} />
                      <input type="text" placeholder="0000 0000 0000 0000" className="w-full pl-10 pr-4 py-3 bg-white/5 border border-white/10 text-white rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 placeholder:text-slate-600" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <input type="text" placeholder="MM/AA" className="w-full px-4 py-3 bg-white/5 border border-white/10 text-white rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 placeholder:text-slate-600" />
                    <input type="text" placeholder="CVC" className="w-full px-4 py-3 bg-white/5 border border-white/10 text-white rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 placeholder:text-slate-600" />
                  </div>
                </div>
