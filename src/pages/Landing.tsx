...
export default function Landing() {
  return (
    <div className="min-h-screen bg-[#050614] font-sans text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center gap-8 font-medium text-sm">
              ...
              <a href="#demo" className="text-slate-400 hover:text-white transition-colors">Portail Captif</a>
              <div className="h-4 w-px bg-white/10"></div>
              <Link to="/portal" className="text-slate-400 hover:text-white transition-colors">Démo Client</Link>
              <Link to="/dashboard" className="bg-indigo-500 hover:bg-indigo-600 text-white px-4 py-2 text-sm font-semibold rounded-full transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <motion.p 
              ...
              className="text-lg text-slate-300 mb-10 tracking-wide"
            >
            ...
            >
              <Link to="/dashboard" className="inline-flex items-center justify-center gap-2 bg-indigo-500 text-white px-8 py-3.5 rounded-full font-medium text-lg hover:bg-indigo-600 transition-all shadow-lg shadow-indigo-500/30">
                Lancer mon Wi-Fi <ArrowRight size={20} />
              </Link>
              <Link to="/portal" className="inline-flex items-center justify-center gap-2 bg-white/5 text-white border border-white/10 px-8 py-3.5 rounded-full font-medium text-lg hover:bg-white/10 transition-all backdrop-blur-md">
      ...
      {/* Features */}
      <section id="features" className="py-24 relative z-10 border-y border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold tracking-tight text-white">Un écosystème complet pour votre établissement</h2>
            <p className="mt-4 text-lg text-slate-400">Générez des revenus tout en offrant une expérience fluide à vos visiteurs.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white/5 border border-white/10 p-8 rounded-3xl backdrop-blur-md">
              ...
              <h3 className="text-xl font-bold mb-3 text-white">Portail Captif</h3>
              <p className="text-slate-400 leading-relaxed">Offrez une page de connexion à votre image. Authentifiez vos clients via réseaux sociaux ou e-mail en un clic.</p>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 p-8 rounded-3xl backdrop-blur-md">
              ...
              <h3 className="text-xl font-bold mb-3 text-white">Régie Publicitaire</h3>
              <p className="text-slate-400 leading-relaxed">Affichez des publicités vidéos ou bannières géolocalisées avant la connexion pour offrir le Wi-Fi gratuitement.</p>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 p-8 rounded-3xl backdrop-blur-md">
              ...
              <h3 className="text-xl font-bold mb-3 text-white">Analyses Visiteurs</h3>
              <p className="text-slate-400 leading-relaxed">Collectez des statistiques détaillées, fidélisez vos clients et lancez des campagnes SMS/Email ciblées.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="pricing" className="py-24 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold tracking-tight text-white">Des tarifs adaptés à votre croissance</h2>
            <p className="mt-4 text-lg text-slate-400">Sans engagement. Résiliez ou changez de forfait à tout moment.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-md flex flex-col">
              ...
              <p className="text-slate-400 mt-2 text-sm">Pour les petits cafés</p>
              <div className="my-6">
              ...
              <button className="w-full py-3 px-4 rounded-xl border border-white/20 bg-white/5 text-white font-medium hover:bg-white/10 transition-colors">
                Commencer
              </button>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-md flex flex-col">
              ...
              <p className="text-slate-400 mt-2 text-sm">Pour les hôtels & réseaux de franchises</p>
              <div className="my-6">
      ...
      {/* Footer */}
      <footer className="bg-black/20 backdrop-blur-md text-slate-400 py-12 border-t border-white/5 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-bold text-xl tracking-tight text-white">WiFiCash</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="hover:text-white transition-colors">Portail Captif</a></li>
              <li><a href="#" className="hover:text-white transition-colors">RÃ©gie Publicitaire</a></li>
              <li><a href="#" className="hover:text-white transition-colors">FidÃ©litÃ© & CRM</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Tarifs</a></li>
            </ul>
          </div>
          <div>
            <h4 className="text-white font-medium mb-4">Mentions</h4>
            <ul className="space-y-2 text-sm">
              <li className="flex items-center gap-2"><ShieldCheck size={14} /> <a href="#" className="hover:text-white transition-colors">RGPD Compliant</a></li>
              <li><a href="#" className="hover:text-white transition-colors">SÃ©curitÃ© SSL & Chiffrement</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Conditions GÃ©nÃ©rales</a></li>
            </ul>
          </div>
          <div>
